...
<!-- <div id="valido" class="container">
  <div class="alert alert-success alert-certificado centro">
    ...
    <br class="clear">
    Atestamos que o certificado número: <b class="res-codigo">01</b>
    é valido, referente ao curso de <b class="res-codigo">Curso</b> feito por <b
      class="res-codigo">Edilson</b>
    com validade <b class="res-codigo">01/10/1931</b>.
  </div>
</div> -->
